...
class User extends BaseController
{
    ...
    function editUser()
    {
            ...
            else
            {
                ...
                redirect('administrator/userListing');
            }
    ...
    function profile($active = "details")
    {
        ...
        $this->loadViews("backend/profile", $this->global, $data, NULL);
    }
    ...
    function profileUpdate($active = "details")
    {
        ...
        else
        {
            ...
            redirect('administrator/profile/'.$active);
        }
    }
