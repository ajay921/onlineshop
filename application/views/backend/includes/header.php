...
<html>
  <head>
    ...
    <!-- Ionicons 2.0.0 -->
    <link href="<?php echo base_url(); ?>assets/backend/bower_components/Ionicons/css/ionicons.min.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
              <a href="<?php echo base_url(); ?>administrator/categoryListing">
                <i class="fa fa-users"></i>
                <span>Category</span>
              </a>
            </li>
            <li>
              <a href="<?php echo base_url(); ?>administrator/productListing">
                <i class="fa fa-users"></i>
                <span>Products</span>
              </a>
            </li>
