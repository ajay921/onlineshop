              ...
              <!-- general form elements -->
                ...
                <div class="box box-warning">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url(); ?>assets/backend/dist/img/avatar.png" alt="User profile picture">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="<?= ($active == "details")? "active" : "" ?> tab-pane" id="details">
                            <form action="<?php echo base_url() ?>administrator/profileUpdate" method="post" id="editProfile" role="form">
...
<script src="<?php echo base_url(); ?>assets/backend/js/editUser.js" type="text/javascript"></script>