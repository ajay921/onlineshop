...
Within the download you'll find the following directories and files, logically grouping common assets/backend and providing both compiled and minified variations. You'll see something like this:
